...
fnames = ['Abdomen_{:05d}.jpg'.format(i) for i in range(300)]
for fname in fnames:
    src = os.path.join(original_abdomen_dir, fname)
    dst = os.path.join(train_abdomen_dir, fname)
    shutil.copy(src, dst)

fnames = ['Abdomen_{:05d}.jpg'.format(i) for i in range(300, 400)]
for fname in fnames:
    src = os.path.join(original_abdomen_dir, fname)
    dst = os.path.join(validation_abdomen_dir, fname)
    shutil.copy(src, dst)
    
fnames = ['Abdomen_{:05d}.jpg'.format(i) for i in range(400, 500)]
for fname in fnames:
    src = os.path.join(original_abdomen_dir, fname)
    dst = os.path.join(test_abdomen_dir, fname)
    shutil.copy(src, dst)

fnames = ['Femur_{:05d}.jpg'.format(i) for i in range(300)]
for fname in fnames:
    src = os.path.join(original_femur_dir, fname)
    dst = os.path.join(train_femur_dir, fname)
    shutil.copy(src, dst)

fnames = ['Femur_{:05d}.jpg'.format(i) for i in range(300, 400)]
for fname in fnames:
    src = os.path.join(original_femur_dir, fname)
    dst = os.path.join(validation_femur_dir, fname)
    shutil.copy(src, dst)
    
fnames = ['Femur_{:05d}.jpg'.format(i) for i in range(400, 500)]
for fname in fnames:
    src = os.path.join(original_femur_dir, fname)
    dst = os.path.join(test_femur_dir, fname)
    shutil.copy(src, dst)

fnames = ['Head_{:05d}.jpg'.format(i) for i in range(300)]
for fname in fnames:
    src = os.path.join(original_head_dir, fname)
    dst = os.path.join(train_head_dir, fname)
    shutil.copy(src, dst)

fnames = ['Head_{:05d}.jpg'.format(i) for i in range(300, 400)]
for fname in fnames:
    src = os.path.join(original_head_dir, fname)
    dst = os.path.join(validation_head_dir, fname)
    shutil.copy(src, dst)
    
fnames = ['Head_{:05d}.jpg'.format(i) for i in range(400, 500)]
for fname in fnames:
    src = os.path.join(original_head_dir, fname)
